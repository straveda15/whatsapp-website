...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full border-t border-[#d8e6fe] bg-[#f0f6ff] px-4 text-center text-[#0a1128] sm:px-6 lg:px-8">
      <div className="relative mx-auto w-full max-w-6xl">
        {/* ── Main Footer Row: centered, evenly spaced columns ── */}
        <div className="flex flex-col items-start gap-6 border-b border-[#d8e6fe] pb-5 pt-6 text-left sm:flex-row sm:flex-wrap sm:items-start sm:justify-evenly sm:*:px-4">
          {/* ── Column 1: Brand & Bio ── */}
          ...
          {/* ── Column 5: Contact Us ── */}
          <div id="contact-us" className="flex flex-col items-start">
            <h4 className="mb-3 text-[10.5px] font-bold uppercase tracking-[0.14em] text-[#2563eb] sm:text-[11px]">
              Contact Us
            </h4>
            ...
            <div className="space-y-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-start gap-2.5 text-[13px] text-[#64748b] transition-colors hover:text-[#0a1128]"
              >
                <Mail
                  size={15}
        ...
        <div className="flex flex-col items-center gap-3 py-4 text-[11px] font-medium text-[#64748b] sm:flex-row sm:flex-wrap sm:justify-evenly sm:text-[11.5px]">
