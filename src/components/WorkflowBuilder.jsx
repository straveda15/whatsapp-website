  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl">
        ...
        {/* ── Dotted Canvas Card ── */}
        <div
          className="mt-10 overflow-hidden rounded-[28px] border border-[#e2e8f0] bg-white p-5 sm:p-8 lg:p-12 shadow-[0_10px_35px_rgba(15,23,42,0.03)] sm:mt-14"
          style={{
            backgroundImage:
        ...
        >
          ...
          <div className="mx-auto flex max-w-[380px] flex-col items-center">
            ...
            {/* Node 1: New Lead */}
            <div className="flex h-11 w-full items-center justify-center rounded-2xl border border-[#bfdbfe] bg-[#e6f0fd] text-[13.5px] font-medium text-[#1d4ed8] shadow-xs">
              New Lead
            </div>
            ...
            <div className="flex h-11 w-full items-center justify-center rounded-2xl border border-[#e2e8f0] bg-white text-[13.5px] font-medium text-[#0a1128] shadow-xs">
              Ask Requirement
            </div>
            ...
            <div className="grid w-full grid-cols-2 gap-3.5">
              {/* High */}
              <div className="flex h-10 items-center justify-center rounded-2xl border border-[#bbf7d0] bg-[#dafbe4] text-[13px] font-medium text-[#15803d]">
                High
              </div>

              {/* Low */}
              <div className="flex h-10 items-center justify-center rounded-2xl border border-[#fed7aa] bg-[#fff7ed] text-[13px] font-medium text-[#c2410c]">
                Low
              </div>
            </div>
            ...
            {/* Sales / Nurture Nodes */}
            <div className="grid w-full grid-cols-2 gap-3.5">
              <div className="flex h-10 items-center justify-center rounded-2xl border border-[#e2e8f0] bg-white text-[13px] font-medium text-[#0a1128] shadow-xs">
                Sales
              </div>
